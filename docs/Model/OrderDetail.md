...
**main_amount** | **int** | مجموع قیمت‌های اولیه تمام کالاها بدون تخفیف (به تومان) | [readonly]
...
**discount_amount** | **int** | کل تخفیف اعمال شده بر سفارش (به تومان) | [readonly]
...
**preparation_time** | **int** | زمان آمادهسازی سفارش (به روز) | [readonly]
...
**digipay_markup_amount** | **int** | مبلغ نشانه‌گذاری برای سفارش (به تومان) | [readonly]
**markup_commission_percentage** | **int** | درصد کمیسیون نشانه‌گذاری برای سفارش (به درصد) | [readonly]
