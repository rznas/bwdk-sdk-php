...
/**
 * PaginatedOrderDetailList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedOrderDetailList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedOrderDetailList';
    ...
    protected static $openAPITypes = [
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\OrderDetail[]'
    ];
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\OrderDetail[] $results results
     *
     * @return self
     */
