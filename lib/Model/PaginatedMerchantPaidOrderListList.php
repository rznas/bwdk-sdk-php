...
/**
 * PaginatedMerchantPaidOrderListList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedMerchantPaidOrderListList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedMerchantPaidOrderListList';
    ...
    protected static $openAPITypes = [
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\MerchantPaidOrderList[]'
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\MerchantPaidOrderList[]
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\MerchantPaidOrderList[] $results results
     *
     * @return self
     */
