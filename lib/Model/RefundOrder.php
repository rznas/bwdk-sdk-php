...
class RefundOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reason
     *
     * @param string|null $reason دلیل اختیاری برای بازگرداندن وجه
     *
     * @return self
     */
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 500)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling RefundOrder., must be smaller than or equal to 500.');
        }
