...
class OrderDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets main_amount
     *
     * @param int $main_amount مجموع قیمت اولیه تمام کالاهای سفارش بدون تخفیف (به تومان)
     *
     * @return self
     */
     ...
     *
     * @param int $discount_amount مبلغ کل تخفیف اعمال شده بر سفارش (به تومان)
     *
     * @return self
     */
     ...
     *
     * @param int $preparation_time Preparation time for the order (in days)
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param float $weight Total weight of the order (in grams)
     *
     * @return self
     */
     ...
     *
     * @param int $digipay_markup_amount Markup amount for the order (in Tomans)
     *
     * @return self
     */
     ...
     *
     * @param int $markup_commission_percentage Markup commission percentage for the order (in percent)
     *
     * @return self
     */
