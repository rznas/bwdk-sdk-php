...
class OrderCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'order_start_url' => 'setOrderStartUrl',
    ...
    protected static $getters = [
        'order_start_url' => 'getOrderStartUrl',
    ...
    {
        $this->setIfExists('order_start_url', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_start_url'] === null) {
            $invalidProperties[] = "'order_start_url' can't be null";
        }
    ...
    /**
     * Gets order_start_url
     *
     * @return string
     */
    public function getOrderStartUrl()
    {
        return $this->container['order_start_url'];
    }

    /**
     * Sets order_start_url
     *
     * @param string $order_start_url order_start_url
     *
     * @return self
     */
    public function setOrderStartUrl($order_start_url)
    {
        if (is_null($order_start_url)) {
            throw new \InvalidArgumentException('non-nullable order_start_url cannot be null');
        }
        $this->container['order_start_url'] = $order_start_url;
