 ...
 */
class VerifyOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VerifyOrder';
     ...
     *
     * @param string $merchant_unique_id شناسه منحصر به فرد ارسال شده هنگام ایجاد سفارش برای تأیید اصالت سفارش
     *
     * @return self
     */
