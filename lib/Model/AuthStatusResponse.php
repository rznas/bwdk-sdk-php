...
/**
 * AuthStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuthStatusResponse';
     ...
     *
     * @param bool $is_authenticated Authentication status
     *
     * @return self
     */
