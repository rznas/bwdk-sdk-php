...
class MerchantOrderReviveShipmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets message
     *
     * @param string $message پیام موفق‌‌
     *
     * @return self
     */
     ...
     * Sets order_uuid
     *
     * @param string $order_uuid شناسه منحصر به فرد سفارش
     *
     * @return self
     */
     ...
     * Sets status_display
     *
     * @param string $status_display وضعیت قابل‌خواندن
     *
     * @return self
     */
