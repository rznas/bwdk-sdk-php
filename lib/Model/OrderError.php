 ...
 */
class OrderError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_OrderError';
    ...
    protected static $openAPITypes = [
        'error' => '\OpenAPI\Client\Model\ErrorEnum'
    ];
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\Model\ErrorEnum
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\Model\ErrorEnum $error error
     *
     * @return self
     */
