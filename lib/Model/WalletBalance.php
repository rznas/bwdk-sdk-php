...
class WalletBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'amount' => false,
        'negative_settlement_deadline' => true
    ];
    ...
    protected static $setters = [
        'amount' => 'setAmount',
        'negative_settlement_deadline' => 'setNegativeSettlementDeadline'
    ];
    ...
    protected static $getters = [
        'amount' => 'getAmount',
        'negative_settlement_deadline' => 'getNegativeSettlementDeadline'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('negative_settlement_deadline', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['negative_settlement_deadline'] === null && !$this->isNullableSetToNull('negative_settlement_deadline')) {
            $invalidProperties[] = "'negative_settlement_deadline' can't be null";
        }
     ...
     * Sets amount
     *
     * @param int|null $amount Current wallet balance in Tomans
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling WalletBalance., must be smaller than or equal to 2147483647.');
        }
        if (($amount < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling WalletBalance., must be bigger than or equal to -2147483648.');
        }
    ...
    /**
     * Gets negative_settlement_deadline
     *
     * @return string|null
     */
    public function getNegativeSettlementDeadline()
    {
        return $this->container['negative_settlement_deadline'];
    }

    /**
     * Sets negative_settlement_deadline
     *
     * @param string|null $negative_settlement_deadline Deadline for settling negative balance
     *
     * @return self
     */
    public function setNegativeSettlementDeadline($negative_settlement_deadline)
    {
        if (is_null($negative_settlement_deadline)) {
            array_push($this->openAPINullablesSetToNull, 'negative_settlement_deadline');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('negative_settlement_deadline', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['negative_settlement_deadline'] = $negative_settlement_deadline;
